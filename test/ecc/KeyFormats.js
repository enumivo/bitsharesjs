...
var test = function(key) {
    describe("KeyFormats", function() {
        ...
        describe("Key Formats", function() {
            ...
            it("Create EON short address", function() {
                var public_key = PublicKey.fromPublicKeyString(key.public_key);
                assert.equal(key.eon_address, public_key.toAddressString());
            })
            ...
            it("EON public key import / export", function() {
                var public_key = PublicKey.fromPublicKeyString(key.public_key);
                assert.equal(key.public_key, public_key.toPublicKeyString());
            });
...
test({
    public_key: "EON7jDPoMwyjVH5obFmqzFNp4Ffp7G2nvC7FKFkrMBpo7Sy4uq5Mj",
    ...
    eon_address: "EON8DvGQqzbgCR5FHiNsFf8kotEXr8VKD3mR",
    ...
    Uncompressed_BTC:	"EONLAFmEtM8as1mbmjVcj5dphLdPguXquimn",
    Compressed_BTC:	"EONANNTSEaUviJgWLzJBersPmyFZBY4jJETY",
    Uncompressed_PTS:	"EONEgj7RM6FBwSoccGaESJLC3Mi18785bM3T",
    Compressed_PTS:	"EOND5rYtofD6D4UHJH6mo953P5wpBfMhdMEi",
    null_public_key: "EON1111111111111111111111111111111114T1Anm"
});
