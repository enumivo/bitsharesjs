...
class TransactionBuilder {
    ...
    */
    ...
    /**
        ...
        @arg {array<string>} [signer_pubkeys = null] - Optional ["EONAbc9Def0...", ...].  These are additional signing keys.  Some balance claims require propritary address formats, the witness node can't tell us which ones are needed so they must be passed in.  If the witness node can figure out a signing key (mostly all other transactions), it should not be passed in here.
